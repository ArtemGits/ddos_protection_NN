...
num_features = 84
num_classes = 2
batch_size_train = 1 #1000
batch_size_test = 1  #128
num_epochs = 1
...
def create_model(batch_size):
    ...
    model.add(LSTM(256, batch_input_shape=(batch_size, 83, 1), return_sequences=True ))  
...
def preprocess(dataset):
    ...
    X_str = np.concatenate((flow_id, source_ip, destination_ip,timestamp), axis=1)
    print(X_str)
