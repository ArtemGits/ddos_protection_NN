...
# history = model.fit(
#     X_train, y_train, epochs=epochs, batch_size=batch_size, verbose=1, shuffle=True, validation_data=(X_train, y_train))
history = model.fit(
    X_train, y_train, epochs=epochs, batch_size=batch_size, verbose=1, shuffle=True, validation_data=(X_test, y_test))

# verbose=0 - dont print epochs

#
# %%%
# run with verbose=1
# ЭТИ ДАННЫЕ X_test, y_test
